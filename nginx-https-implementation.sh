#!/Bin/bash
# =============================================================================
#  Sécurité Web - Configuration HTTPS complète sur NGINX (VERSION AMÉLIORÉE)
...
echo "=========================================================="
echo "  Configuration HTTPS NGINX - secure-domain.ma "
...
<head>
    ...
    <title> Sécurité Web - HTTPS Configuré</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p><strong> Sécurité Web</strong></p>
...
# Générée automatiquement -  Sécurité Web
# =============================================================================
